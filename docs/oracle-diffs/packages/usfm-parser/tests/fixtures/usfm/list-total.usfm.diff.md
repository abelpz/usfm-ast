# Oracle diff: `packages/usfm-parser/tests/fixtures/usfm/list-total.usfm`
...
```diff
--- packages/usfm-parser/tests/fixtures/usfm/list-total.usfm (original)
+++ packages/usfm-parser/tests/fixtures/usfm/list-total.usfm (roundtripped)
@@ -1 +1 @@
+ \pm
