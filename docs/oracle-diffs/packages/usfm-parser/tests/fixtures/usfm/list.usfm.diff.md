# Oracle diff: `packages/usfm-parser/tests/fixtures/usfm/list.usfm`
...
```diff
--- packages/usfm-parser/tests/fixtures/usfm/list.usfm (original)
+++ packages/usfm-parser/tests/fixtures/usfm/list.usfm (roundtripped)
@@ -1 +1 @@
+ \id 1CH
+ \c 27
