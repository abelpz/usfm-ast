# Oracle diff: `examples/usfm-markers/char-w/w-example-3/example.usfm`
...
```diff
--- examples/usfm-markers/char-w/w-example-3/example.usfm (original)
+++ examples/usfm-markers/char-w/w-example-3/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id NEH
+ \c 9
+ \q1
