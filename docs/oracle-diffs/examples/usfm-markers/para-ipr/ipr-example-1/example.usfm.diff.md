# Oracle diff: `examples/usfm-markers/para-ipr/ipr-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/para-ipr/ipr-example-1/example.usfm (original)
+++ examples/usfm-markers/para-ipr/ipr-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id GEN
