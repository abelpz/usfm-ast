# Oracle diff: `examples/usfm-markers/para-h/h-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/para-h/h-example-1/example.usfm (original)
+++ examples/usfm-markers/para-h/h-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id MAT
- \id MAT
  \h Matthew
