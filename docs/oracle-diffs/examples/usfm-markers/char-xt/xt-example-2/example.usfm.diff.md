# Oracle diff: `examples/usfm-markers/char-xt/xt-example-2/example.usfm`
...
```diff
--- examples/usfm-markers/char-xt/xt-example-2/example.usfm (original)
+++ examples/usfm-markers/char-xt/xt-example-2/example.usfm (roundtripped)
@@ -1 +1 @@
+ \p
