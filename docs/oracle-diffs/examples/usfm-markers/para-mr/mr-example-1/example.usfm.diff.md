# Oracle diff: `examples/usfm-markers/para-mr/mr-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/para-mr/mr-example-1/example.usfm (original)
+++ examples/usfm-markers/para-mr/mr-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id PSA
+ \c 1
+ \ms1 Book One
