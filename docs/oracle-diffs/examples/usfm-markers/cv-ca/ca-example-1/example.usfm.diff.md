# Oracle diff: `examples/usfm-markers/cv-ca/ca-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/cv-ca/ca-example-1/example.usfm (original)
+++ examples/usfm-markers/cv-ca/ca-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \c 54
+ \s1 A Prayer for Protection from Enemies
+ \d \va 1 \va*A poem by David, \va 2 \va*after the men from Ziph went to Saul and told him that David was hiding in their territory.
+ \q1
+ \v 1 Save me by your power, O God;
