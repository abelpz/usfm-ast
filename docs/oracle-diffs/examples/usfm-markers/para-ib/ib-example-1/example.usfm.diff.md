# Oracle diff: `examples/usfm-markers/para-ib/ib-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/para-ib/ib-example-1/example.usfm (original)
+++ examples/usfm-markers/para-ib/ib-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id GEN
