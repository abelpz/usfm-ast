# Oracle diff: `examples/usfm-markers/char-ref/ref-example-2/example.usfm`
...
```diff
--- examples/usfm-markers/char-ref/ref-example-2/example.usfm (original)
+++ examples/usfm-markers/char-ref/ref-example-2/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id MAT
+ \c 5
+ \p
