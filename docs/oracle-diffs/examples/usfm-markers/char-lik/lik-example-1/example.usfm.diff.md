# Oracle diff: `examples/usfm-markers/char-lik/lik-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/char-lik/lik-example-1/example.usfm (original)
+++ examples/usfm-markers/char-lik/lik-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id 1CH
+ \c 27
