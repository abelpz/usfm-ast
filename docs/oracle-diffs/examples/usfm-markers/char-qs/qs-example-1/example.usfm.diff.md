# Oracle diff: `examples/usfm-markers/char-qs/qs-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/char-qs/qs-example-1/example.usfm (original)
+++ examples/usfm-markers/char-qs/qs-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id PSA
+ \c 3
