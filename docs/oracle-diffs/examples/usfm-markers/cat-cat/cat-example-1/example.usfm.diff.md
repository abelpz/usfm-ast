# Oracle diff: `examples/usfm-markers/cat-cat/cat-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/cat-cat/cat-example-1/example.usfm (original)
+++ examples/usfm-markers/cat-cat/cat-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id MAT
+ \c 1
+ \p
...
+ \p
+ \v 2-6a From Abraham to King David, the following ancestors are listed: Abraham, Isaac, Jacob, Judah and his brothers; then Perez and Zerah (their mother was Tamar \ef - \fr 1.2-6a: \fq Tamar: \ft Bore her twin sons out of wedlock (Gen 38.6-30).\ef*), Hezron, Ram, Amminadab, Nahshon, Salmon, Boaz (his mother was Rahab\ef - \fr 1.2-6a: \fq Rahab: \ft A prostitute in Jericho (Josh 2.1-21; 6.17-25; Jas 2.25).\ef*), Obed (his mother was Ruth\ef - \fr 1.2-6a: \fq Ruth: \ft A Moabite (Ruth 1.4). Only outstanding women were normally included in Jewish genealogical lists.\ef*), Jesse, and King David.
+ \p
+ \v 6b-11 From David to the time when the people of Israel were taken into exile in Babylon\ef - \fr 1.6b-11: \fq exile in Babylon: \ft In 597 \sc BC\sc* King Nebuchadnezzar of Babylonia conquered Jerusalem and took many of its inhabitants as prisoners to his country (2 Kgs 24.10-16; 2 Chr 36.9-10).\ef*, the following ancestors are listed: ...
- \id MAT
- \c 1
- \p
