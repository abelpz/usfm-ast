# Oracle diff: `examples/usfm-markers/char-tcr/tcr-example-1/example.usfm`
...
```diff
--- examples/usfm-markers/char-tcr/tcr-example-1/example.usfm (original)
+++ examples/usfm-markers/char-tcr/tcr-example-1/example.usfm (roundtripped)
@@ -1 +1 @@
+ \id NUM
+ \c 2
+ \p
